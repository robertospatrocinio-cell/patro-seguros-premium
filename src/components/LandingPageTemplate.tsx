    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b">
        <div className="container mx-auto px-4 flex items-center justify-between h-14">
          <Link to="/">
            <img src={logoUrl} alt="Patro Seguros" width={160} height={40} className="h-10 w-auto" loading="eager" decoding="sync" fetchPriority="high" />
          </Link>
      ...
      <main id="main-content" className="pt-14">
        ...
        <footer className="py-8 bg-background border-t">
          <div className="container mx-auto px-4 text-center">
            <img src={logoUrl} alt="Patro Seguros" width={144} height={32} loading="lazy" decoding="async" className="h-8 w-auto mx-auto mb-3" />
