  ...
  return (
    <>
      ...
      <InsurancePageTemplate
        ...
        title={title}
        subtitle={subtitle}
        badge={slug.includes("bmw") || slug.includes("mercedes") || slug.includes("audi") || slug.includes("porsche") || slug.includes("ferrari") || slug.includes("antigo") || slug.includes("estradeira") || slug.includes("moto-bmw") || slug.includes("ducati") || slug.includes("harley") || slug.includes("moto-honda") || slug.includes("moto-yamaha") ? "Especialista Premium" : undefined}
