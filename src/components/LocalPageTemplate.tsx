  ...
  return (
    <>
      ...
      <InsurancePageTemplate
        ...
        title={title}
        subtitle={subtitle}
        badge={slug.includes("bmw") || slug.includes("mercedes") || slug.includes("audi") || slug.includes("porsche") || slug.includes("moto-bmw") || slug.includes("ducati") || slug.includes("harley") || slug.includes("moto-honda") ? "Especialista Premium" : undefined}
