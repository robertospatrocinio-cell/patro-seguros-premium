...
const SOBRE_FAQS = [
  ...
  },
  {
    ...
    answer: `Av. Salgado Filho, 2120 — Sala 219, Edifício Via Alameda, bairro Cidade Maia, Guarulhos/SP. Atendimento presencial de segunda a sexta, ${EMPRESA.horario}; WhatsApp 24h em ${EMPRESA.telefone}.`,
  },
  {
    question: "A Patro Seguros é regulamentada pela SUSEP?",
    answer: `Sim. A Patro Corretora de Seguros possui registro ativo na SUSEP nº ${EMPRESA.susep} e pode ser consultada publicamente no portal oficial da Superintendência de Seguros Privados.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Auto, moto, vida, residencial, viagem, plano de saúde, empresarial, frota, transporte, galpões, responsabilidade civil, cyber, agro, consórcio e previdência privada — via ${EMPRESA.metricas.seguradorasParceiras} seguradoras parceiras.`,
  },
];
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="mt-8 rounded-xl border border-emerald-200 bg-emerald-50/60 p-5 md:p-6 flex flex-col md:flex-row md:items-center gap-4 justify-between">
              ...
              <div className="flex flex-col sm:flex-row gap-2 md:shrink-0">
                ...
                <a href="https://www2.susep.gov.br/safe/menumercado/regcorretores/pesquisa.asp" className="inline-flex" target="_blank" rel="noopener noreferrer">
                  <Button size="sm" className="w-full sm:w-auto">
                    Consultar SUSEP <a className="ml-2 h-4 w-4" / target="_blank" rel="noopener noreferrer">
                  </Button>
                </a>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-background rounded-2xl overflow-hidden border shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    <a href="https://linkedin.com/in/roberto-patrocinio" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">
                      <Linkedin className="h-3.5 w-3.5" /> LinkedIn
                    </a>
                    <a href="https://www.instagram.com/patroseguros" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">
              ...
              <div className="bg-background rounded-2xl overflow-hidden border shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    <a href="https://linkedin.com/in/sandra-patrocinio" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">
                      <Linkedin className="h-3.5 w-3.5" /> LinkedIn
                    </a>
                    <a href="https://www.instagram.com/patroseguros" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">
                      <Instagram className="h-3.5 w-3.5" /> Instagram
              ...
              <div className="space-y-6">
                <div className="p-6 rounded-2xl border bg-slate-50/50 shadow-sm">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="https://www.google.com/maps?cid=273879799324962533" className="flex-1" target="_blank" rel="noopener noreferrer">
                        ...
                        return (
                          <li key={ev.label}>
                            <a
                              ...
                              {isExternal && <a className="h-3 w-3 opacity-50" / target="_blank" rel="noopener noreferrer">}
                            </a>
                          </li>
                        );
                      })}
              ...
              <dl className="grid sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                ...
                <div>
                  ...
                  <dd className="text-muted-foreground">
                    <a href="https://www2.susep.gov.br/safe/menumercado/regcorretores/pesquisa.asp" className="underline hover:text-primary" target="_blank" rel="noopener noreferrer">
                      212113511
                    </a>
                  </dd>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <dd className="text-muted-foreground flex flex-wrap gap-x-3 gap-y-1">
                    <a href="https://www.google.com/maps?cid=273879799324962533" className="underline hover:text-primary" target="_blank" rel="noopener noreferrer">Google Maps</a>
                    <span aria-hidden>·</span>
                    <a href="https://www.instagram.com/patroseguros" className="underline hover:text-primary" target="_blank" rel="noopener noreferrer">Instagram</a>
                    <span aria-hidden>·</span>
                    <a href="https://www.facebook.com/patroseguros" className="underline hover:text-primary" target="_blank" rel="noopener noreferrer">Facebook</a>
                    <span aria-hidden>·</span>
                    <a href="https://www.linkedin.com/company/patro-seguros" className="underline hover:text-primary" target="_blank" rel="noopener noreferrer">LinkedIn</a>
                    <span aria-hidden>·</span>
                    <a href="https://wa.me/551151997500" className="underline hover:text-primary" target="_blank" rel="noopener noreferrer">WhatsApp</a>
                  </dd>
                </div>
              </dl>
            </div>
