...
const BlogOdontologia = () => {
  const categoryArticles = articles.filter(a => a.category === "Odontologia");

  return (
    <>
      <PageMeta
        title="Odontologia e Gestão de Riscos – Blog Patro Seguros"
        description="Conteúdo especializado para dentistas, consultórios e clínicas odontológicas: seguros, LGPD, gestão de riscos e proteção patrimonial."
      />
      <Header />
      <main id="main-content">
        <section className="gradient-hero py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-white mb-4">Odontologia e Gestão de Riscos</h1>
            <p className="text-xl text-white/70 max-w-2xl mx-auto">
              Conteúdo especializado para dentistas, clínicas odontológicas e redes do setor.
            </p>
          </div>
        </section>
...
export default BlogOdontologia;