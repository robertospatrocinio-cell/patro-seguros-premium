  ...
  return (
    <InsurancePageTemplate
      ...
      faqs={[
        ...
        { question: "Quais cidades e estados a Patro atende?", answer: "Atendemos produtores rurais de todos os 26 estados brasileiros e o Distrito Federal — capitais, interior e zona rural. Desde o Sul (PR, SC, RS) até o Norte (PA, TO, RO), passando por Centro-Oeste (MT, MS, GO), Sudeste (SP, MG, ES, RJ) e Nordeste (BA, PI, MA)." },
        { question: "Qual o prazo para receber a proposta de seguro?", answer: "Após o envio das informações (tipo de granja, localização, valor dos bens), retornamos com propostas comparativas de diversas seguradoras em até 24 horas úteis." },
        { question: "Como solicitar cotação se estou longe de Guarulhos?", answer: "Todo o processo é 100% remoto. Basta entrar em contato pelo WhatsApp (11) 5199-7500, telefone ou e-mail. Enviamos a documentação digitalmente e acompanhamos tudo à distância — da cotação ao sinistro." },
        { question: "A proposta é enviada por e-mail ou WhatsApp?", answer: "Enviamos as propostas comparativas pelo canal de sua preferência — WhatsApp, e-mail ou ambos. Você recebe um resumo com valores, coberturas e condições de cada seguradora para comparar e escolher a melhor opção." },
      ]}
      relatedInsurances={[
