...
const SeguroDroneAgricola = () => {
  return (
    <InsurancePageTemplate
      ...
      icon="🚁"
      metaDescription="Seguro para Drone Agrícola — proteção contra quedas, colisões e falhas técnicas em drones de pulverização e mapeamento. Cotação grátis Patro Seguros."
