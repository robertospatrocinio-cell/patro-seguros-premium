...
const SeguroDroneAgricola = () => {
  return (
    <InsurancePageTemplate
      ...
      faqs={[
        { question: "A Patro Seguros atende operadores de drone fora de São Paulo?", answer: "Sim! Atendemos operadores de drones agrícolas em todos os estados do Brasil. Nossa sede é em Guarulhos/SP, mas o atendimento é 100% remoto — cotação, emissão e sinistro." },
        { question: "Preciso de seguro para drone agrícola?", answer: "Sim. Além de proteger um equipamento de alto valor (drones agrícolas custam de R$ 50 mil a R$ 500 mil), o seguro é essencial para cobrir responsabilidade civil por danos a terceiros e atender exigências da ANAC." },
        { question: "Quanto custa o seguro de drone agrícola?", answer: "O valor varia conforme o modelo, valor do drone, coberturas e região de operação. Em média, custa entre 3% e 8% do valor do equipamento ao ano. Faça uma cotação gratuita." },
        { question: "O seguro cobre queda do drone durante pulverização?", answer: "Sim. A cobertura de danos físicos protege o drone contra quedas, colisões e acidentes operacionais durante voos de pulverização ou mapeamento." },
        { question: "Drones DJI Agras são cobertos?", answer: "Sim! Trabalhamos com seguros para todos os modelos de drones agrícolas, incluindo DJI Agras T10, T16, T20, T30, T40 e T50, além de outras marcas." },
        { question: "Posso segurar a frota de drones da minha empresa?", answer: "Sim! Oferecemos condições especiais para frotas de drones agrícolas, com descontos progressivos conforme o número de equipamentos segurados." },
      ]}
      relatedInsurances={[
