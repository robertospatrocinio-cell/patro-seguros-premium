...
const SeguroPlacaSolar = () => {
  return (
    <InsurancePageTemplate
      ...
      icon="☀️"
      metaDescription="Seguro para Placas Solares e sistemas fotovoltaicos. Proteção contra granizo, furto, danos elétricos e fenômenos naturais. Cotação grátis Patro Seguros."
