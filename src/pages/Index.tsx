...
const parceiros = ["Porto", "Tokio Marine", "Allianz", "Azul", "Mapfre", "HDI", "Zurich", "Bradesco", "Liberty", "Suhai", "Justos", "Darwin", "Ituran", "SulAmérica", "Akad", "SURA", "SOMPO", "Itaú", "AXA", "Bradesco Saúde", "Amil", "Porto Saúde", "HapVida/NotreDame", "Prevent Senior", "MedSenior", "Omint", "Unimed"];
