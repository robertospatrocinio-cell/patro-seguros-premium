...
const SeoSeguroMotoristaAppGuarulhos = () => (
  <InsurancePageTemplate
    ...
    description="Seguro para motorista de aplicativo em Guarulhos com cobertura específica para uso profissional do veículo em Uber, 99, InDriver, iFood, Rappi e demais plataformas. A Patro Seguros é especialista local, fundada em 2021 por sócios com mais de 20 anos de experiência, com mais de 200 motoristas de app já protegidos na região, com cláusulas contratuais que garantem indenização real em caso de sinistro durante corridas ou entregas."
