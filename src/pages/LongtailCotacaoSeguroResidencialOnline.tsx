...
A Patro Seguros mostra o comparativo completo com franquia, sublimites por cobertura, assistência 24h (chaveiro, encanador, eletricista) e diferenciais de cada produto — não apenas o preço. Você escolhe o que faz sentido para o seu imóvel em Guarulhos ou Grande SP e contrata em 24h.`}
    ...
    howItWorks={[
      ...
      { step: "2", title: "Cotamos em 16 seguradoras", description: "Porto Seguro, Bradesco, Allianz, SulAmérica, HDI, Tokio, Mapfre, Liberty, Zurich, Sompo e mais em uma única passada." },
    ...
    faqs={[
      { question: "Como funciona a cotação de seguro residencial online?", answer: "Você preenche um formulário rápido (CEP, tipo do imóvel, valor a segurar, coberturas desejadas) e a Patro cota em 16 seguradoras simultaneamente — Porto, Bradesco, Allianz, SulAmérica, HDI, Tokio, Mapfre, Liberty, Zurich, Sompo e mais. O comparativo chega no seu WhatsApp em até 2h." },
      ...
      <section aria-labelledby="cotacao-seguro-residencial-guarulhos" className="py-12 bg-muted/30">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-foreground/80">
            As 16 seguradoras cotadas simultaneamente pela Patro incluem Porto Seguro, Bradesco Auto RE, Allianz Casa, SulAmérica Residencial, HDI Residencial, Tokio Marine, Mapfre, Liberty, Zurich, Sompo e mais. Cada uma tem forças diferentes: Porto lidera em assistência 24h, Allianz em preço para casa térrea, SulAmérica em danos elétricos, Bradesco em cobertura de joias. A cotação online mostra qual se encaixa melhor no seu perfil.
          </p>
        </div>
      </section>
    )}
