...
Cada tipo de empresa tem riscos específicos: um restaurante tem risco de incêndio alto; uma loja de eletrônicos tem risco de roubo elevado; uma indústria química tem risco ambiental. Na Patro, fazemos análise de risco por segmento para garantir coberturas adequadas — nem de mais (que encarece), nem de menos (que deixa buracos na proteção).`}
      ...
      realScenarios={[
        { title: "Incêndio em restaurante", description: "Após incêndio total, o seguro pagou R$ 380 mil em danos materiais e R$ 120 mil em lucros cessantes, garantindo a sobrevivência do negócio após 15 anos de trabalho." },
        { title: "Roubo em escritório", description: "Escritório recuperou R$ 65 mil após roubo de computadores e servidor. A cobertura de eletrônicos garantiu a rápida retomada das operações sem prejuízo ao caixa." },
        { title: "Acidente com cliente (RC)", description: "Cliente fraturou o braço em uma loja e processou a empresa em R$ 35 mil. O seguro cobriu integralmente o acordo judicial e os honorários advocatícios." },
        { title: "Danos elétricos em supermercado", description: "Curto-circuito queimou motor de câmara fria. O seguro cobriu R$ 30 mil entre reparo e perda de estoque de perecíveis, evitando prejuízo operacional direto." },
      ]}
      importantDetails={[
