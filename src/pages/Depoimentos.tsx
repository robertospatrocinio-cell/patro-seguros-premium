              ...
              {videoTestimonials.map((v, i) => (
                <div key={i} className="group relative bg-background rounded-xl border overflow-hidden">
                  <div className="aspect-video bg-muted flex items-center justify-center relative">
                    <img src={v.thumb} alt="Depoimento de cliente Patro Seguros" width={640} height={360} sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" className="absolute inset-0 w-full h-full object-cover opacity-30" loading="lazy" decoding="async" />
