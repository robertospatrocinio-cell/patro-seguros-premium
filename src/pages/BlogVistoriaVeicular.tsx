...
const BlogVistoriaVeicular = () => {
  const categoryArticles = articles.filter(a => a.category === "Vistoria Veicular");

  return (
    <>
      <PageMeta 
        title="Vistoria Veicular – Blog Patro Seguros" 
        description="Dicas, guias e informações sobre seguros para empresas de vistoria veicular, ECVs e inspeção técnica." 
      />
      <Header />
      <main id="main-content">
        <section className="gradient-hero py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-white mb-4">Vistoria Veicular</h1>
            <p className="text-xl text-white/70 max-w-2xl mx-auto">
              Conteúdo especializado para ECVs, perícias cautelares e centros de inspeção técnica.
            </p>
          </div>
        </section>
...
export default BlogVistoriaVeicular;
