...
const LandingConsorcio = () => (
  <LandingPageTemplate
    ...
    title="Consórcio"
    heroEmoji="🏆"
    headline="Consórcio de Automóveis: Como trocar de carro sem pagar dois para o banco?"
    subheadline="O financiamento tradicional é o inimigo do seu patrimônio. Use o consórcio como estratégia de inteligência financeira para ampliar frota ou trocar de veículo."
    metaDescription="Consórcio de carros em Guarulhos: troque de veículo sem juros abusivos. Estratégia de troca planejada e estudo de lance com a Patro Seguros."
    ctaText="Falar com Consultor Estratégico"
