...
const SeguroGeada = () => {
  return (
    <InsurancePageTemplate
      ...
      description="Seguro Geada: proteção essencial para lavouras de café, milho e hortaliças. Atendemos produtores de todo o Brasil com subsídio federal e suporte remoto."
      icon="❄️"
