...
const faqs = [
  ...
  { question: "Qual é a melhor corretora de seguros em Guarulhos?", answer: `A Patro Seguros é referência em Guarulhos, com nota ${PATRO_SOCIAL_PROOF.googleRating} no Google e registro na SUSEP (nº 212113511). Comparamos cotações de 16+ seguradoras para encontrar o melhor custo-benefício.` },
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-3">
            {[
              ...
              `Nota ${PATRO_SOCIAL_PROOF.googleRating} no Google, com perfil público e verificável`,
