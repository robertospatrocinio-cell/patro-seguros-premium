...
const faqs = [
  ...
  { question: "Qual é a melhor corretora de seguros em Guarulhos?", answer: `A Patro Seguros é referência em Guarulhos, com nota ${PATRO_SOCIAL_PROOF.googleRating} no Google, ${PATRO_SOCIAL_PROOF.googleReviewCount} avaliações positivas e registro na SUSEP (nº 212113511). Comparamos cotações de 16+ seguradoras para encontrar o melhor custo-benefício.` },
  ...
  { question: "Como funciona o atendimento presencial?", answer: "Nosso escritório fica na Av. Salgado Filho, 2120 – Ed. Via Alameda – Sala 219 – Cidade Maia, com fácil acesso e estacionamento. Atendemos de segunda a sexta das 8h30 às 18h. Recomendamos agendar pelo WhatsApp." },
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-3">
            {[
              ...
              `Nota ${PATRO_SOCIAL_PROOF.googleRating} no Google com ${PATRO_SOCIAL_PROOF.googleReviewCount} avaliações de clientes reais`,
