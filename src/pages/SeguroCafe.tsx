...
const SeguroCafe = () => {
  return (
    <InsurancePageTemplate
      ...
      description="Seguro Café: proteção ideal para cafeicultores contra geada, seca e granizo. Atendemos Minas Gerais, São Paulo e outros estados com suporte 100% remoto."
      icon="☕"
      metaDescription="Seguro Café em todo o Brasil: proteção da lavoura cafeeira contra geada, seca, granizo e excesso de chuva. Subsídio federal. Cotação grátis."
