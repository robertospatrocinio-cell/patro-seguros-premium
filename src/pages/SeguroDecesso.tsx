...
const SeguroDecesso = () => {
  return (
    <InsurancePageTemplate
      ...
      description="Seguro Decesso empresarial: assistência funeral completa para colaboradores e familiares. Cobre despesas funerais, suporte logístico e financeiro à família."
...
O seguro pode ser contratado para o titular (colaborador), cônjuge, filhos e pais, com diferentes planos de cobertura que vão do básico (funeral simples) ao premium (funeral completo com serviços adicionais como floricultura, coffee break, carro de acompanhamento e assistência psicológica).`}
      ...
      realScenarios={[
        { title: "Óbito em viagem a trabalho", description: "Colaborador faleceu em viagem. O seguro cobriu o traslado interestadual e o funeral completo, retirando toda a carga logística da empresa e da família." },
        { title: "Assistência para dependentes", description: "Após falecimento do pai de uma funcionária, o seguro cobriu todas as despesas funerais. A colaboradora pôde focar no luto sem preocupações financeiras." },
        { title: "Custos evitados pela empresa", description: "Uma empresa economizou R$ 12 mil em despesas funerais diretas ao contratar o Seguro Decesso por apenas R$ 250 mensais para todo o quadro de 50 funcionários." },
      ]}
      importantDetails={[
