    ...
    <main id="main-content" tabIndex={-1}>
      ...
      <section className="gradient-hero py-20">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h1 className="text-white mb-4">Proteção Completa para Clínicas e Hospitais Veterinários</h1>
          <p className="text-lg text-white/70 mb-8">Sua missão é cuidar dos animais. Nossa missão é proteger seu patrimônio, sua equipe e seu negócio.</p>
