...
const SeguroFuneral = () => {
  return (
    <InsurancePageTemplate
      ...
      description="O Seguro Funeral cobre despesas de sepultamento e cremação para o segurado e familiares. Garanta dignidade sem custos extras no momento do falecimento."
