...
const SeguroAmbiental = () => (
  <InsurancePageTemplate
    ...
    description="O Seguro Ambiental oferece cobertura para empresas contra custos de remediação, danos a terceiros e responsabilidade civil decorrentes de eventos de poluição e contaminação ambiental. Essencial para indústrias, transportadoras de produtos perigosos, postos de combustível e qualquer atividade com potencial impacto ao meio ambiente. A Patro Seguros atende empresas e produtores rurais de todos os estados do Brasil — cotação, emissão e acompanhamento de sinistro de forma 100% remota."
    coverages={[
    ...
    faqs={[
      { question: "A Patro Seguros atende empresas fora de São Paulo?", answer: "Sim! Atendemos empresas e produtores rurais de todos os estados do Brasil. O atendimento é 100% remoto — cotação, emissão e acompanhamento de sinistro." },
