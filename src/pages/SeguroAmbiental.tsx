...
const SeguroAmbiental = () => (
  <InsurancePageTemplate
    ...
    icon="🌿"
    metaDescription="Seguro Ambiental para indústrias, transportadoras e postos de combustível. Cobertura contra poluição, contaminação e remediação. Cotação grátis Patro Seguros."
