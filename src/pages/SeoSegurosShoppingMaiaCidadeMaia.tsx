      ...
      <div className="grid lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            <a href="https://www.google.com/maps/dir/?api=1&destination=Av.+Salgado+Filho,+2120+-+Cidade+Maia,+Guarulhos+-+SP" className="inline-flex items-center gap-2 bg-accent text-accent-foreground px-4 py-2 rounded-md font-semibold hover:bg-accent/90 transition" target="_blank" rel="noopener noreferrer">
              <Navigation className="w-4 h-4" aria-hidden="true" />
              Como chegar (Google Maps)
            </a>
            <a href="https://waze.com/ul?q=Av.+Salgado+Filho,+2120,+Cidade+Maia,+Guarulhos" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-md font-semibold hover:bg-primary/90 transition" target="_blank" rel="noopener noreferrer">
              <Navigation className="w-4 h-4" aria-hidden="true" />
              Abrir no Waze
            </a>
            <Link
...
Nossa equipe técnica acompanha o sinistro do início ao fim. Em caso de furto em loja, alagamento em sala comercial, batida no estacionamento do shopping ou processo contra um profissional liberal, o cliente fala diretamente com seu corretor responsável — sem call center, sem URA, sem sistema de senha. É essa proximidade que nos rendeu a indicação de PMEs e famílias na região.`}
    ...
    realScenarios={[
      { title: "Curto-circuito em loja do Shopping Maia", description: "Loja recuperou R$ 85 mil após curto-circuito. O seguro empresarial cobriu danos materiais e lucros cessantes pelos 22 dias de reforma, resolvido em 18 dias." },
      { title: "Processo em consultório no Via Alameda", description: "Dentista evitou prejuízo de R$ 200 mil em processo judicial. O seguro de RC profissional cobriu defesa e acordo, protegendo o patrimônio do profissional." },
      { title: "Furto de carro na Cidade Maia", description: "Cliente teve indenização de R$ 92 mil paga em 12 dias após furto. Com suporte da Patro, a reposição do veículo foi rápida e sem burocracia excessiva." },
      { title: "Economia em quiosque no Shopping Maia", description: "Quiosque migrou para apólice 40% mais barata com a Patro, economizando R$ 2.500/ano sem perder coberturas essenciais de incêndio e RC." },
    ]}
    tips={[
