...
const SeguroPecuario = () => {
  return (
    <InsurancePageTemplate
      ...
      description="O Seguro Pecuário oferece proteção para seu rebanho contra doenças e acidentes. Atendemos criadores em todo o Brasil com subsídio federal e suporte remoto."
      icon="🐄"
      metaDescription="Seguro Pecuário em todo o Brasil para bovinos, equinos e suínos. Proteção contra morte por doenças, acidentes e raios. Subsídio do governo."
