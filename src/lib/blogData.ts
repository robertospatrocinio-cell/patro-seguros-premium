...
export const articles: BlogArticleMeta[] = [
  ...
  { slug: "seguro-motorista-aplicativo-guia", title: "Seguro para Motorista de Aplicativo: Guia Completo 2026", excerpt: "Tudo o que motoristas de Uber, 99 e inDrive precisam saber sobre seguro auto: coberturas obrigatórias, preços, RC passageiros e como evitar ter o sinistro negado.", category: "Seguro Auto", tags: ["seguro auto", "motorista app", "uber", "99", "guarulhos", "dicas"], author: "Roberto Patro", date: "2026-03-26", readTime: 12 },
  { slug: "corretora-de-seguros-em-guarulhos", title: "Corretora de Seguros em Guarulhos: Como Escolher a Melhor", excerpt: "Procurando corretora de seguros em Guarulhos? Saiba como funciona o mercado, tipos de cobertura e por que contar com um corretor especializado faz toda a diferença.", category: "Dicas", tags: ["guarulhos", "corretora", "cotação", "seguro auto", "seguro vida", "seguro residencial", "seguro empresarial"], author: "Roberto Patro", date: "2026-04-06", readTime: 10 },
];
