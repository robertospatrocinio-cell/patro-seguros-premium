...
export const INSURANCE_HUB: HubCategory[] = [
   {
     ...
     links: [
      ...
      { label: "Seguro Caminhão", href: "/seguro-caminhao" },
       ...
       { label: "Seguro Micro-ônibus", href: "/seguro-micro-onibus" },
  ...
  },
   {
     ...
     links: [
      { label: "Seguro Residencial", href: "/seguro-residencial" },
       { label: "Seguro Condomínio Residencial", href: "/seguro-condominio-residencial" },
       { label: "Seguro Condomínio Empresarial", href: "/seguro-condominio-empresarial" },
  ...
  },
   {
     ...
     links: [
      ...
      { label: "Seguro de Máquinas", href: "/seguro-maquinas" },
       ...
       { label: "Seguro Trator Industrial", href: "/seguro-trator-industrial" },
       { label: "Seguro Linha Amarela", href: "/seguro-maquinas-linha-amarela" },
       { label: "Seguro Gerador de Energia", href: "/seguro-gerador-energia" },
      ...
      { label: "Seguro Engenharia", href: "/seguro-engenharia" },
       ...
       { label: "Seguro Petshop", href: "/seguro-petshop" },
       { label: "Seguro Restaurante", href: "/seguro-restaurante" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Seguro Drone Agrícola", href: "/seguro-drone-agricola" },
       ...
       { label: "Seguro Trator Agrícola", href: "/seguro-trator-agricola" },
       { label: "Seguro Colhedora de Cana", href: "/seguro-colhedora-cana" },
       { label: "Seguro Colheitadeira de Grãos", href: "/seguro-colheitadeira-graos" },
       { label: "Seguro Colhedora de Algodão", href: "/seguro-colhedora-algodao" },
       { label: "Seguro Pulverizador Agrícola", href: "/seguro-pulverizador-agricola" },
       { label: "Seguro Silo Agrícola", href: "/seguro-silo-agricola" },
