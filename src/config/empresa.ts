...
export const EMPRESA = {
  ...
  posicionamento:
    "Especialistas em proteger famílias e empresas em Guarulhos através de uma consultoria técnica, comparando 16+ seguradoras para garantir a melhor cobertura pelo menor custo real.",
  redesSociais: {
