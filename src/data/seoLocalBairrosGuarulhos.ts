...
export const seoLocalBairrosGuarulhos: Record<string, SeoLocalPageConfig> = BAIRROS_MATRIZ.reduce((acc, b) => {
  ...
  acc[b.slug] = {
    ...
    subtitle: `Corretora de Seguros em ${b.nome}, Guarulhos. Compare e cote as melhores seguradoras com a Patro Seguros.`,
    description: `Buscando seguros no ${b.nome}, Guarulhos? A Patro Seguros oferece atendimento consultivo ${b.referencia}. ${b.perfil} Proteja seu patrimônio com quem conhece a região.`,
    metaDescription: `Seguros no bairro ${b.nome} em Guarulhos: auto, residencial, vida, saúde e empresarial. Atendimento local ${b.referencia}. Cotação rápida na Patro!`,
    icon: "📍",
    neighborhood: b.nome,
    city: "Guarulhos",
