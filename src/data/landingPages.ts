...
export const landingPagesData: Record<string, LandingPageContent> = {
  "seguro-auto-guarulhos": {
    ...
    icon: "🚗",
    location: "Guarulhos",
    detailedDescription: "Guarulhos possui um dos trânsitos mais intensos do Brasil, com as rodovias Dutra e Fernão Dias. Isso afeta o custo do seguro. Nossa consultoria analisa perfil e CEP de pernoite para encontrar the melhor preço em Guarulhos, seja no Centro, Vila Augusta ou Pimentas.\n\nA Patro Seguros atua em Guarulhos com equipe de sócios que há mais de 20 anos no mercado (empresa com sócios há mais de 20 anos). Fazemos o comparativo completo entre Porto Seguro, Allianz, HDI, Tokio Marine, Bradesco, SulAmérica, Liberty, Mapfre e Azul. Você recebe a tabela comparativa em 2h, sem compromisso.",
  ...
  "seguro-byd-dolphin": {
    ...
    heroImage: "https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&q=80&w=2000",
    insuranceType: "auto",
    icon: "⚡",
    location: "Guarulhos",
  ...
  "seguro-byd-song-plus": {
    ...
    heroImage: "https://images.unsplash.com/photo-1621135802920-133df287f89c?auto=format&fit=crop&q=80&w=2000",
    insuranceType: "auto",
    icon: "🔋",
    location: "Guarulhos",
