...
segmentos.push(
  ...
  },
  {
    ...
    icon: "🧴",
    subtitle: "Seguro empresarial e RC profissional para estética em Guarulhos",
    description: "Proteção para aparelhos de laser, equipamentos e cobertura contra processos de pacientes em Guarulhos.",
    detailedDescription: "### Seguro para Clínicas de Estética em Guarulhos\n\nClínicas de estética em Guarulhos possuem equipamentos de alto custo (laser, criolipólise) e risco de processos por danos em procedimentos. Combinamos o seguro patrimonial com o RC Profissional para garantir a continuidade do seu nome e do seu negócio.",
    metaDescription: "Seguro para Clínicas de Estética em Guarulhos: equipamentos e RC profissional. Cotação em 2h com a Patro Seguros.",
    coverages: baseCoverages,
