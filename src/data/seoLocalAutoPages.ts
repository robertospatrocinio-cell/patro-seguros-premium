...
const buildBairroConfig = (b: BairroSeed): SeoLocalPageConfig => ({
  ...
  metaDescription: `Seguro auto ${b.bairro} Guarulhos: cotação online, melhores preços e atendimento local. Compare 9 seguradoras com a Patro Seguros. ${b.priceRange}.`,
  icon: "🚗",
...
seoLocalPages["seguro-auto-vila-galvao"] = {
  ...
  testimonials: [
    {
      name: "Cláudia M.",
      role: "Moradora do Vila Galvão",
      text: "Pagava R$ 4.150 no seguro do meu HR-V renovando direto na Porto. A Patro recotou e fechei na Allianz por R$ 3.280 com a mesma cobertura. Atendimento super atencioso e tudo por WhatsApp.",
      rating: 5,
    },
    {
      name: "Eduardo R.",
      role: "Vila Galvão — Engenheiro",
      text: "Comprei um Compass usado e fiz a cotação com 3 corretoras. A Patro foi a única que mandou comparativo em quadro com 8 seguradoras. Consegui R$ 900 a menos que a melhor proposta das outras.",
      rating: 5,
    },
    {
      name: "Renata P.",
      role: "Vila Galvão — Advogada",
      text: "Tive um sinistro pequeno (vidro quebrado) e o suporte da Patro fez toda a diferença. Resolveram a autorização com a seguradora em 24h. Já indiquei pra metade do meu prédio.",
      rating: 5,
    },
  ],
};
