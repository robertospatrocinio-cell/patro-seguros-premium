...
const planoSaudePmeGuarulhos: SeoLocalPageConfig = {
  ...
  metaDescription: "Plano de saúde PME Guarulhos a partir de 2 vidas. Compare Hapvida, Notredame, Amil, Bradesco, SulAmérica, Unimed. Cotação grátis em 4h úteis com a Patro Seguros.",
  icon: "👥",
