...
const melhorCorretora: SeoLocalPageConfig = {
  ...
  subtitle: "Patro Seguros: corretora SUSEP em Guarulhos (fundada em 2021, sócios com 20+ anos de mercado), com 4.7 no Google, mais de 500 apólices ativas e atendimento presencial no Cidade Maia.",
  description: `Procurando a melhor corretora de seguros em Guarulhos? A Patro Seguros é referência local com sócios com mais de 20 anos de experiência no mercado (empresa fundada em 2021): registro SUSEP, escritório físico no Cidade Maia, nota 4.7 no Google e mais de 500 apólices ativas em seguro auto, vida, residencial, empresarial e plano de saúde. ${partnersLine}`,
  ...
  faqs: [
    { question: "Por que a Patro é considerada a melhor corretora de seguros em Guarulhos?", answer: "Por reunir presença local (escritório físico no Cidade Maia, com sócios com mais de 20 anos de mercado), credenciais regulatórias (SUSEP), reputação comprovada (4.7 no Google com avaliações reais), portfólio amplo (9 seguradoras e 16 operadoras de saúde) e atendimento personalizado em todas as etapas." },
