...
const melhorCorretora: SeoLocalPageConfig = {
  ...
  subtitle: "Patro Seguros: corretora SUSEP em Guarulhos (fundada em 2021, sócios com 20+ anos de mercado), com 4.9 no Google, mais de 500 apólices ativas e atendimento presencial no Cidade Maia.",
  description: `Procurando a melhor corretora de seguros em Guarulhos? A Patro Seguros é referência local com sócios com mais de 20 anos de experiência no mercado (empresa fundada em 2021): registro SUSEP, escritório físico no Cidade Maia, nota 4.9 no Google e mais de 500 apólices ativas em seguro auto, vida, residencial, empresarial e plano de saúde. ${partnersLine}`,
