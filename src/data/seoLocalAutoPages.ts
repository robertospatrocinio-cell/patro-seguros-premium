...
const seguroShoppingInternacional: SeoLocalPageConfig = {
  ...
  detailedDescription: "O Internacional Shopping Guarulhos possui um dos maiores fluxos de pessoas do Brasil. Para the lojista, isso significa visibilidade, mas também exposição a riscos operacionais. Nossa consultoria foca em apólices robustas de Responsabilidade Civil e proteção de estoque contra vazamentos e furtos.\n\nAtuamos em Guarulhos com sócios que somam mais de 20 anos de mercado (empresa com sócios há mais de 20 anos) e conhecemos as exigências específicas do condomínio do Internacional Shopping. O seguro é fundamental para garantir que um incidente em uma unidade não comprometa todo o negócio.",
...
const melhorCorretora: SeoLocalPageConfig = {
  ...
  subtitle: "Patro Seguros: corretora SUSEP em Guarulhos (com sócios há mais de 20 anos, sócios com 20+ anos de mercado), com 4.9 no Google, mais de 500 apólices ativas e atendimento presencial no Cidade Maia.",
  description: `Procurando a melhor corretora de seguros em Guarulhos? A Patro Seguros é referência local com sócios com mais de 20 anos de experiência no mercado (empresa com sócios há mais de 20 anos): registro SUSEP, escritório físico no Cidade Maia, nota 4.9 no Google e mais de 500 apólices ativas em seguro auto, vida, residencial, empresarial e plano de saúde. ${partnersLine}`,
