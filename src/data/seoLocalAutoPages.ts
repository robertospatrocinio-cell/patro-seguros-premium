...
const cotacaoSeguroAuto: SeoLocalPageConfig = {
  ...
  title: "Cotação Seguro Auto Guarulhos — 16 Seguradoras em 2h",
...
const seguroEmpresarialCumbica: SeoLocalPageConfig = {
  ...
  faqs: [
    ...
    { question: "Posso parcelar o seguro empresarial em Cumbica?", answer: "Sim. As condições de pagamento e parcelamento variam conforme seguradora, produto e perfil do risco. Para empresas com fluxo de caixa apertado, também é possível negociar pagamento mensal proporcional sem entrada inicial." },
...
const seguroTransportadora: SeoLocalPageConfig = {
  ...
  whyPatro: [
    "transportadoras ativas em Guarulhos na carteira e região",
...
const seguro99: SeoLocalPageConfig = {
  ...
  detailedDescription: `### O Risco de Dirigir para 99 sem Seguro Adequado\n\nDirigir para a 99 em Guarulhos sem seguro adequado é o maior risco financeiro de qualquer motorista de aplicativo. O seguro auto comum não cobre sinistros durante corridas remuneradas — em caso de acidente com passageiro a bordo, a seguradora pode negar indenização integralmente, deixando o motorista responsável pelo prejuízo do veículo, despesas médicas e danos a terceiros.\n\n### Como Funciona o Seguro 99 em Guarulhos\n\nO seguro 99 Guarulhos correto exige uma cláusula contratual expressa que declare o uso profissional em aplicativo. Algumas seguradoras oferecem essa cláusula como cobertura adicional, com custo entre R$ 300 e R$ 1.200/ano dependendo do perfil. Hoje, em Guarulhos, trabalham com cláusula confiável: Allianz, HDI, Tokio Marine, Porto Seguro (com restrições), Bradesco e Mapfre.\n\n### Atendimento Especializado Patro Seguros\n\nA Patro Seguros é especialista em seguro para motorista de aplicativo desde 2018 e já protegeu mais de 180 motoristas 99 em Guarulhos. Cotamos com as 6 seguradoras que aceitam cláusula expressa, entregamos comparativo em até 2 horas úteis e acompanhamos o motorista no primeiro sinistro para garantir aplicação correta da cobertura.`,
  ...
  pricingNote: "Dica Patro: motorista 99 Guarulhos com mais de 20 anos, sem sinistros nos últimos 3 anos e com rastreador instalado economiza até 28% no prêmio em relação ao perfil padrão.",
  faqs: [
...
const planoSaudeEmpresarialGuarulhos: SeoLocalPageConfig = {
  ...
  whyPatro: [
    "Cotação entre 16 operadoras de saúde em até 4 horas úteis",
    "Especialistas em saúde empresarial PME, com sócios com mais de 20 anos de experiência",
...
const seguroAutoBarato: SeoLocalPageConfig = {
  ...
  whyPatro: [
    ...
    "Comparação entre seguradoras a cada renovação, com foco em custo-benefício real",
...
const planoSaudePmeGuarulhos: SeoLocalPageConfig = {
  ...
  whyPatro: [
    ...
    "Especialistas em PME, com sócios com mais de 20 anos de experiência no segmento — 2 a 29 vidas",
...
const planoSaudeFamiliaGuarulhos: SeoLocalPageConfig = {
  ...
  whyPatro: [
    ...
    "Especialistas em saúde família e individual, com sócios com mais de 20 anos de experiência",
...
seoLocalPages["seguro-auto-vila-galvao"] = {
  ...
  testimonials: [
    ...
    },
    {
      ...
      neighborhood: "Vila Galvão",
      quote: "Comprei um Compass usado e fiz a cotação com 3 corretoras. A Patro foi a única que mandou comparativo em quadro com 16 seguradoras. Consegui R$ 900 a menos que a melhor proposta das outras.",
      rating: 5,
    },
    {
...
const seguroGalpaoCumbica: SeoLocalPageConfig = {
  ...
  faqs: mergeGalpaoFAQs([
    ...
    { question: "A Patro atende sinistro grave em galpão de Cumbica no fim de semana?", answer: "Sim. Plantão 24/7 para sinistros graves (incêndio, alagamento, roubo grande, vazamento). Em Cumbica, com a concentração logística da região, a maioria dos sinistros graves acontece fora do horário comercial. Em carteira ativa de apólices no polo, a Patro acompanhou perícia, ajustamento e regulação com 92% de indenização integral nos últimos 5 anos." },
...
const cities: CitySeed[] = [
  ...
  { slug: "seguro-auto-sao-caetano-do-sul", city: "São Caetano do Sul", region: "abc", riskLevel: "baixo", priceRange: "R$ 2.200 a R$ 4.500/ano", context: "menor cidade do ABC e uma das de maior IDH do Brasil, com perfil residencial premium e baixos índices de roubo de veículo.", highlights: ["CEPs de baixíssimo risco (Cerâmica, Olímpico, Santa Paula)", "Excelente faixa de preço para perfil 20+ anos de experiência", "Concentração de veículos premium"] },
