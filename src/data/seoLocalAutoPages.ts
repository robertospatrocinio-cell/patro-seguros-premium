...
const buildBairroConfig = (b: BairroSeed): SeoLocalPageConfig => ({
  ...
  detailedDescription: `O ${b.bairro} é uma ${b.context} Para o seguro auto, o CEP de pernoite é uma das variáveis mais importantes no cálculo do prêmio: seguradoras consultam estatísticas de roubo, furto e colisão por logradouro antes de fechar a apólice.\n\nA Patro Seguros atua em Guarulhos desde 2008 e atende moradores do ${b.bairro} ${b.reference}. Em vez de você ter que procurar 8 seguradoras diferentes, fazemos uma única cotação e enviamos o comparativo entre Porto Seguro, Allianz, HDI, Tokio Marine, Bradesco, SulAmérica, Liberty, Mapfre e Azul. Você decide com transparência total. Nossa sede fica no Cidade Maia, garantindo proximidade e confiança para quem mora ou trabalha no ${b.bairro}.\n\nNossa orientação é específica para o perfil de risco do bairro: classificação ${b.riskLevel} de sinistralidade, recomendações sobre rastreador, garagem coberta, uso profissional e franquia ideal. Tudo pensado para reduzir o prêmio sem comprometer cobertura. Além do seguro de carro, oferecemos proteção para frotas comerciais, motoristas de aplicativo e seguros de motos com as mesmas condições competitivas.\n\nContratar um seguro no ${b.bairro} através da Patro significa ter um consultor dedicado que conhece as ruas da cidade. Sabemos que a segurança no entorno do ${b.reference} exige coberturas específicas para acessórios e retrovisores, por exemplo. Garantimos que sua apólice não tenha brechas e que, em caso de imprevisto, o suporte seja humanizado e ágil, com guincho ilimitado e carro reserva conforme sua necessidade.`,
