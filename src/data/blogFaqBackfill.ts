...
export const blogFaqBackfill: Record<string, { q: string; a: string }[]> = {
  ...
  "como-evitar-prejuizos-incendio": [
    ...
    { q: "A Patro Seguros atende lojistas e franquias em toda Guarulhos e região metropolitana?", a: "Sim. A Patro Seguros é uma corretora sediada em Guarulhos/SP (Cidade Maia) e atua há mais de 20 anos em toda a região metropolitana e demais cidades do estado, com atendimento nacional para carteiras específicas. O time acompanha desde a cotação até a regulação de sinistros — envie o artigo \"Como evitar prejuízos após um incêndio\" pelo WhatsApp para receber a orientação adequada." },
  ],
