...
export const blogFaqBackfill: Record<string, { q: string; a: string }[]> = {
  "como-criar-uma-gestao-de-riscos-em-ecvs": [
    { q: "Como solicitar uma cotação de vistoria veicular em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Como criar uma gestão de riscos em ECVs.\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "como-evitar-prejuizos-incendio": [
    ...
    { q: "A Patro Seguros atende lojistas e franquias em toda Guarulhos e região metropolitana?", a: "Sim. A Patro Seguros é uma corretora sediada em Guarulhos/SP (Cidade Maia) fundada em 2021 por sócios com mais de 20 anos de experiência em toda a região metropolitana e demais cidades do estado, com atendimento nacional para carteiras específicas. O time acompanha desde a cotação até a regulação de sinistros — envie o artigo \"Como evitar prejuízos após um incêndio\" pelo WhatsApp para receber a orientação adequada." },
  ],
  ...
  "como-proteger-empresa-vistoria-against-processos": [
    { q: "Como solicitar uma cotação de seguro em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Como proteger uma empresa de vistoria contra processos?\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "como-proteger-equipamentos-veterinarios": [
    { q: "Como solicitar uma cotação de veterinária em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Como proteger equipamentos veterinários?\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  ...
  "lgpd-clinicas-veterinarias": [
    { q: "Como solicitar uma cotação de veterinária em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"LGPD para clínicas veterinárias: O que você precisa saber\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "melhores-corretoras-seguros-guarulhos": [
    { q: "Como solicitar uma cotação de dicas em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"As Melhores Corretoras de Seguros em Guarulhos\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "melhores-seguradoras-moradores-guarulhos-2026": [
    { q: "Como solicitar uma cotação de seguradoras em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"As Melhores Seguradoras para Moradores de Guarulhos em 2026\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "o-que-e-responsabilidade-civil-para-ecv": [
    { q: "Como solicitar uma cotação de vistoria veicular em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"O que é responsabilidade civil para ECV?\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "o-que-fazer-apos-sinistro-clinica-veterinaria": [
    { q: "Como solicitar uma cotação de veterinária em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"O que fazer após um sinistro em uma clínica veterinária\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  ...
  "plano-saude-para-pequenas-empresas-de-vistoria": [
    { q: "Como solicitar uma cotação de vistoria veicular em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Plano de saúde para pequenas empresas de vistoria.\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "proteger-dados-clientes-sistemas-veterinarios": [
    { q: "Como solicitar uma cotação de veterinária em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Como proteger dados de clientes em sistemas veterinários\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "proteger-medicamentos-vacinas-clinica": [
    { q: "Como solicitar uma cotação de veterinária em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Como proteger medicamentos e vacinas na clínica\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "proteger-patrimonio-medico-veterinario": [
    { q: "Como solicitar uma cotação de veterinária em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Como proteger o patrimônio do médico veterinário\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "quanto-custa-seguro-clinica-veterinaria": [
    { q: "Como solicitar uma cotação de veterinária em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Quanto custa um seguro para clínica veterinária?\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  ...
  "seguro-para-empresas-credenciadas-pelo-detran": [
    { q: "Como solicitar uma cotação de vistoria veicular em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Seguro para empresas credenciadas pelo Detran.\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "seguro-para-engenheiros-guarulhos-responsabilidade-civil": [
    { q: "Como solicitar uma cotação de rc em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Seguro para Engenheiros em Guarulhos: Responsabilidade Civil\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
  "seguro-para-pet-shops": [
    { q: "Como solicitar uma cotação de veterinária em Guarulhos citada neste artigo?", a: "Fale com a equipe da Patro Seguros pela página /contato ou pelo botão flutuante de WhatsApp. Envie o link deste artigo (\"Seguro para pet shops: Banho, tosa e muito mais\") junto com o CEP e o perfil desejado — a cotação personalizada com as principais seguradoras é enviada em até 2 horas úteis." },
  ],
