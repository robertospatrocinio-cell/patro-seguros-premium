...
export const FULL_SEO_CONTENT = {
  "/": {
    ...
    body: `
      ...
      <p>Uma corretora habilitada pela SUSEP representa o cliente — não a seguradora. Isso significa que trabalhamos para você conseguir a melhor cobertura pelo preço mais adequado ao seu perfil, e defendemos seus interesses em caso de sinistro. Nossos sócios têm mais de 20 anos de experiência profissional em seguros e domina o apetite técnico de cada seguradora, o que permite direcionar cada cotação para quem realmente vai aceitar bem o risco.</p>
